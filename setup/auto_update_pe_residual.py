...
if __name__ == '__main__':
    ...
    try:
        ...
        print('不在swmao本地，结果将更新到数据库，不在本地保存。')
    ...
    try:
        ...
        raise AssertionError('数据库pe_residual_ols_x最新日期与factor_west_pe_180一致，无需更新')
    ...
    factor_west_netprofit_chg_180_6_1m_2d = factor_west_netprofit_chg_180_6_1m.pivot(index='tradingdate', columns='stockcode', values='fv')
    factor_west_netprofit_chg_180_6_1m_2d = factor_west_netprofit_chg_180_6_1m_2d.reindex_like(factor_west_pe_180_2d).loc[begin_date:]
    ...
    factor_west_netprofit_growth_180_2d = factor_west_netprofit_growth_180.pivot(index='tradingdate', columns='stockcode', values='fv')
    factor_west_netprofit_growth_180_2d = factor_west_netprofit_growth_180_2d.reindex_like(factor_west_pe_180_2d).loc[begin_date:]
